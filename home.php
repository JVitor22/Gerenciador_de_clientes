  ...
  <div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
      ...
      <ul class="navbar-nav ml-auto">
        ...
        <h4>Olá <?php echo " " . $_COOKIE['email']?> </h4>
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="../../index3.html" class="brand-link">
        <img src="dist/img/logo.png" alt="logo" class="brand-image img-circle elevation-3"
          style="opacity: .8"/>
        <span class="brand-text font-weight-light">Client Manager</span>
      </a>
      ...
      <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          ...
          <div class="info">
            <a href="#" class="d-block">João Vitor</a>
          </div>
        </div>
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              <div class="inner">
                ...
                <h3><?php echo Cliente::numClientes(); ?></h3>
              ...
              <a href="Source/Views/meus_clientes.php" class="small-box-footer">Ver mais<i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
